...
def usage : String :=
  String.intercalate "\n" [
    ...
    "  beam [--root PATH] [--port N] lean-sync <path> [+all-diagnostics]",
    "  beam [--root PATH] [--port N] lean-refresh <path> [+all-diagnostics]",
    "  beam [--root PATH] [--port N] lean-save <path> [+all-diagnostics]",
    "  beam [--root PATH] [--port N] lean-close <path>",
    "  beam [--root PATH] [--port N] lean-close-save <path> [+all-diagnostics]",
