...
completing a request. Use the closed `BrokerFailure` code set for failures generated by Beam itself;
use `ResponseFailure` when preserving an exact typed backend error and response metadata.
